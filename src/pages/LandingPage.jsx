    ...
    <div className={`landing-page ${themeName}`}>
      ...
      <nav className="landing-nav" role="navigation" aria-label="Main navigation">
        <div className="nav-container-wide">
          ...
          <div className="nav-actions">
            <div className="theme-toggles" role="group" aria-label="Theme selection">
              <button className={`theme-btn ${themeName === 'light' ? 'active' : ''}`} onClick={() => toggleTheme("light")} aria-pressed={themeName === 'light'}>Light</button>
      ...
      <section id="contact" className="cta-section-home">
        <div className="cta-content-home">
          ...
          <p>Join event organizers who trust FairScore for fair, accurate, and professional judging</p>
      ...
      <footer className="landing-footer">
        ...
        <div className="footer-bottom">
          <p>&copy; 2025 FairScore. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
